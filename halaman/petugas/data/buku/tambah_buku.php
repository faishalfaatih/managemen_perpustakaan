...
font-size: 16px;"><a href="../../logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <h5>Silahkan masukan data buku!</h5>
                </div>
                <form role="form" action="input_buku.php" method="POST">
                    <div class="form-group">
                        <label>Kode Buku</label>
                        <input class="form-control" name="kode_buku" required />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="penulis_buku" required />
                    </div>
                    <div class="form-group">
                        <label>Penerbit Buku</label>
                        <input class="form-control" name="penerbit_buku" required />
                    </div>
                    <div class="form-group">
