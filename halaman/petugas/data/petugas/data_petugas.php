...
<head>
    ...
    <title>Data Petugas | Petugas</title>
	<!-- BOOTSTRAP STYLES-->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        include "../../../../koneksi.php";
                                        $no = 1;
                                        $ambil = mysqli_query($koneksi,"SELECT*FROM tab_petugas");
                                        while ($data = mysqli_fetch_array($ambil)) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    <a href="edit_petugas.php?id=<?php echo $data['no_petugas']; ?>" class="btn btn-warning">Edit</a>
                                                    <a href="hapus_petugas.php?id=<?php echo $data['no_petugas']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" class="btn btn-danger">Hapus</a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
