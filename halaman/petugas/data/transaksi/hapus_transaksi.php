...
font-size: 16px;"><a href="../../logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                ?>
                <form role="form" action="proses_hapus.php" method="POST">
                    <div class="form-group">
                        <label for="">ID Transaksi</label>
                        <input type="" class="form-control" name="id_transaksi" value="<?php echo $data['id_transaksi'];?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="">Kode Pinjam</label>
                        <input type="" class="form-control" name="kode_pinjam" value="<?php echo $data['kode_pinjam'];?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="">Kode Kembali</label>
                        <input type="" class="form-control" name="kode_kembali" value="<?php echo $data['kode_kembali'];?>" readonly>
                    </div>
                    </div>
                        <a href="transaksi_buku.php" class="btn btn-primary">< Kembali</a>
                        <input type="submit" name="kembali" value="Hapus" class="btn btn-danger" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')">
                    </div>                                        
                </form>
