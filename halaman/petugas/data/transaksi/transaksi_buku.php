        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="panel-heading">
                    <h5>Daftar transaksi pinjam</h5>
                     <a href="transaksi_pinjam.php" class="btn btn-primary">+ Tambah Transaksi</a>
                     <a href="transaksi_kembali.php" class="btn btn-danger">Transaksi Kembali</a>
                </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        while ($data = mysqli_fetch_array($ambil)) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    <a href="kembali.php?id=<?php echo $data['id_transaksi']; ?>"class="btn btn-warning">Kembalikan</a>
                                ...
                                <a href="../laporan/laporan_pinjam.php" target="_blank" class="btn btn-success"><i class="fa fa-print"> Cetak </i></a>
                            </div>
